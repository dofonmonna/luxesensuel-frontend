...
const REVIEW_POOL = [
  { name: 'Amina K.', city: 'Abidjan', rating: 5, date: '2025-05-12', verified: true,
    text: "Produit reçu en 3 semaines environ, emballage totalement neutre. La qualité dépasse ce que j'attendais. Matières douces, finitions soignées. Le délai en valait la peine, je recommande !" },
  ...
  { name: 'Kofi A.', city: 'Accra', rating: 5, date: '2025-04-19', verified: true,
    text: "Paiement Mobile Money très simple. Livraison en une vingtaine de jours comme annoncé, suivi disponible tout du long. Le produit est exactement comme décrit. Service client réactif. Top !" },
  { name: 'Isabelle M.', city: 'Lyon', rating: 4, date: '2025-04-14', verified: true,
    text: "Très satisfaite de la qualité. Il faut compter environ 3 à 4 semaines de livraison, mais on est prévenu dès le départ et le produit valait vraiment l'attente. Emballage raffiné, parfait pour offrir." },
  ...
  { name: 'Théo & Sandra', city: 'Marseille', rating: 5, date: '2025-03-08', verified: true,
    text: "On a commandé plusieurs articles ensemble. Livraison dans les délais annoncés, emballage sobre et élégant. Les produits sont de qualité professionnelle. On adore !" },
  ...
  { name: 'Lucas P.', city: 'Bordeaux', rating: 4, date: '2025-02-18', verified: true,
    text: "Produit de bonne qualité, correspond bien à la description. Livraison discrète appréciée. Je retire une étoile car la livraison internationale a pris un peu plus de 4 semaines, mais le suivi m'a rassurée tout du long." },
  ...
  { name: 'Camille H.', city: 'Nantes', rating: 5, date: '2025-01-22', verified: true,
    text: "Magnifique produit, parfait pour s'offrir un moment de bien-être. Le packaging est soigné, idéal pour offrir en cadeau. Livraison sans surprise, conforme au délai indiqué." },
  ...
  { name: 'Vanessa L.', city: 'Paris', rating: 5, date: '2025-01-05', verified: true,
    text: "LUXEDropshoping c'est vraiment le top ! Qualité irréprochable, livraison dans les temps annoncés et surtout très discrète. Mon partenaire et moi sommes ravis. On reviendra !" },
  { name: 'Koffi M.', city: 'Douala', rating: 5, date: '2024-12-28', verified: true,
    text: "Excellent ! J'ai anticipé ma commande de Noël environ un mois à l'avance et tout est arrivé à temps. Produit premium, emballage soigné. Merci !" },
];
