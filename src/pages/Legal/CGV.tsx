...
export function CGV() {
  return (
    <div className="min-h-screen bg-[#F5F5F5] font-[Montserrat] py-16 px-4">
      <SEO title="Conditions Générales de Vente" description="Consultez les Conditions Générales de Vente de LUXEDropshoping. Informations sur les commandes, livraisons, retours et paiements." />
      <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-14 shadow-sm border border-gray-100">
        ...
        <div className="prose prose-sm max-w-none text-gray-600 space-y-8">
          <section>
            ...
            <p>Les présentes CGV régissent les ventes de produits effectuées sur le site LUXEDropshoping. Toute commande implique l'acceptation sans réserve de ces conditions.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">2. Produits</h2>
            <p>Les produits proposés sont ceux décrits sur le site au moment de la consultation. Les photographies sont les plus fidèles possibles mais ne constituent pas un engagement contractuel. LUXEDropshoping se réserve le droit de modifier l'assortiment à tout moment.</p>
          </section>
          ...
          <section>
            ...
            <p>La commande est validée après confirmation du paiement. Un email de confirmation est envoyé à l'adresse indiquée. LUXEDropshoping se réserve le droit d'annuler toute commande en cas de problème de paiement ou de suspicion de fraude.</p>
          </section>
          ...
          <section>
            ...
            <p>Les livraisons sont effectuées dans un emballage discret, sans mention du contenu ni du nom de la boutique. Les délais indicatifs sont de 5 à 15 jours ouvrés selon la destination. LUXEDropshoping ne peut être tenu responsable des retards imputables au transporteur ou aux services de douane.</p>
          </section>
          ...
          <section>
            ...
            <p>LUXEDropshoping ne saurait être tenu responsable de l'utilisation inappropriée des produits. Les produits sont destinés à un usage adulte et conforme à leur destination.</p>
          </section>
