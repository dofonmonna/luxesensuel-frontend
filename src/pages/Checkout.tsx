              ...
              >
                ...
                <div className="text-left flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[9px] font-black bg-emerald-500 text-white px-2 py-0.5 rounded-full uppercase tracking-tighter">Mondial</span>
                  </div>
                  <p className="text-xs text-gray-500 leading-tight">Visa · Mastercard · Orange Money · Wave · MTN · Moov</p>
                </div>
