              ...
              >
                ...
                <div className="text-left flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <p className="font-black text-gray-900 text-lg">Mobile Money</p>
                    <span className="text-[9px] font-black bg-emerald-500 text-white px-2 py-0.5 rounded-full uppercase tracking-tighter">Afrique</span>
                  </div>
                  <p className="text-xs text-gray-500 leading-tight">Orange Money · Wave · MTN · Moov Money</p>
                </div>
