...
export function Cart() {
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center p-4 font-[Montserrat]">
        <div className="text-center max-w-md bg-white p-12 rounded-3xl shadow-sm border border-gray-100">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-4">{t('cart.empty')}</h2>
          <p className="text-gray-500 mb-10 text-sm leading-relaxed">{t('cart.continue_shopping')}</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] font-[Montserrat] py-12 px-4">
      <SEO title={t('cart.title')} description={t('cart.title')} noindex={true} />
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-3xl font-black text-gray-900 mb-8 flex items-center gap-4">
          ...
          {t('cart.title')} <span className="text-[#CC0000] font-normal">({items.length} {items.length > 1 ? t('cart.items') : t('cart.item')})</span>
        </h1>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100">
              ...
              <div className="flex items-center justify-between pb-6 mb-6 border-b border-gray-50">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-gray-900 uppercase tracking-widest">{t('cart.items')}</span>
                </div>
                <button 
                  onClick={() => {
                    clearCart();
          ...
          <div className="w-full lg:col-span-1 space-y-6 lg:sticky lg:top-32">
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
              <h2 className="text-xl font-black text-gray-900 mb-8 uppercase tracking-widest text-xs border-b border-gray-50 pb-4">{t('checkout.title')}</h2>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center text-sm font-medium">
                  ...
                  <span className="text-emerald-500 font-bold">{t('cart.free_shipping')}</span>
                </div>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center gap-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                  ...
                  <span>{t('footer.shipping_discreet')}</span>
                </div>
                <div className="flex items-center gap-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
