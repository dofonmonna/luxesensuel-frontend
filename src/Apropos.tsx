...
export default function Apropos() {
  return (
    <main className="bg-gradient-to-b from-champagne to-rose min-h-screen py-20 px-10 text-center animate-fade">
      <h1 className="text-4xl font-garamond text-bordeaux mb-6">À propos de LUXEDropshoping</h1>
      <p className="text-lg text-sensual max-w-3xl mx-auto">
        LUXEDropshoping est né de la passion pour le commerce en ligne accessible à tous.
