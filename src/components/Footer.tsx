        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="mailto:contact@luxedropshoping.com" className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-[#CC0000] hover:border-[#CC0000] hover:bg-red-50 transition-all duration-300" aria-label="Email">
